...
export const Sidebar: React.FC<Props> = ({
  ...
  return (
    <>
      <div
        className={clsx(
          "absolute z-10 flex h-screen w-screen flex-col justify-between bg-gradient-to-b from-blue-800 to-gray-900 py-8 pb-28 transition-all lg:static lg:w-[300px] lg:min-w-[300px] lg:translate-x-0 lg:pb-8",
          {
